-- Migration: Create calendar_event_processed table if it doesn't exist
-- This table tracks which calendar events have been processed (added as tasks or dismissed)

-- Create calendar_event_processed table
...
DROP POLICY IF EXISTS "Users can manage their own processed calendar events" ON calendar_event_processed;
