import svgPaths from "./svg-1h7t6no93a";
    ...
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[32px] items-start px-[20px] py-0 relative w-full">
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.5] not-italic relative shrink-0 text-[28px] text-nowrap text-white tracking-[-0.308px] whitespace-pre">Today</p>
          <Frame7 />
        </div>
      </div>
    </div>
...
function Frame12() {
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Frame">
          <path d={svgPaths.p6b9cf00} id="Vector" stroke="var(--stroke-0, #5B5D62)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p3f184780} id="Vector_2" stroke="var(--stroke-0, #5B5D62)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
export default function IPhone1415Pro() {
  return (
    <div className="bg-[#110c10] box-border content-stretch flex flex-col items-center justify-between pb-0 pt-[80px] px-0 relative size-full" data-name="iPhone 14 & 15 Pro - 1">
      <Frame8 />
      <Frame1 />
    </div>
  );
