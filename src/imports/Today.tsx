import svgPaths from "./svg-y4ms3lw2z2";

function Frame10() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Medium',sans-serif] font-medium items-start leading-[1.5] not-italic relative shrink-0 text-[28px] text-nowrap tracking-[-0.308px] whitespace-pre">
      <p className="relative shrink-0 text-white">Today</p>
      <p className="relative shrink-0 text-[#5b5d62]">Monday 24th</p>
    </div>
  );
}
