import svgPaths from "./svg-plnyk1jrdz";
...
function Frame11() {
  return (
    <div className="bg-[#e1e6ee] box-border content-stretch flex gap-[4px] items-center justify-center px-[16px] py-[4px] relative rounded-[100px] shrink-0">
...
function Frame12() {
  return (
    <div className="bg-[#0b64f9] box-border content-stretch flex gap-[4px] items-center justify-center px-[16px] py-[4px] relative rounded-[100px] shrink-0">
      <Frame3 />
...
export default function BulkAddActive() {
  return (
    <div className="bg-[#110c10] box-border content-stretch flex flex-col gap-[40px] items-center overflow-clip pb-[60px] pt-[20px] px-0 relative rounded-tl-[32px] rounded-tr-[32px] size-full" data-name="Bulk add active">
      <Frame10 />
      <Frame5 />
    </div>
  );
