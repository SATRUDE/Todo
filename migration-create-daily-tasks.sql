...
DO $$ 
BEGIN
  DROP POLICY IF EXISTS "Users can manage their own daily tasks" ON daily_tasks;
EXCEPTION 
...
-- SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'daily_tasks';
